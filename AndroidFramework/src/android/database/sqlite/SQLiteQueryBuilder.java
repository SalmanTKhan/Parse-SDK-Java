...
/**
 * This is a convenience class that helps build SQL queries
 */
public class SQLiteQueryBuilder {
     ...
     * by parenthesis and ANDed with the selection passed to . The final
     ...
     */
    public void appendWhere(@NotNull CharSequence inWhere) {
     ...
     */
    public void appendWhereEscapeString(@NotNull String inWhere) {
        if (mWhereClause == null) {
            mWhereClause = new StringBuilder(inWhere.length() + 16);
        }
     ...
     */
    public void appendWhereStandalone(@NotNull CharSequence inWhere) {
        if (mWhereClause == null) {
            mWhereClause = new StringBuilder(inWhere.length() + 16);
        }
