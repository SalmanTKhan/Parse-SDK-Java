...
public class ArrayUtils {
    ...
    public static <T> T[] newUnpaddedArray(Class<T> componentType, int minLenght) {
        return (T[]) new Object[minLenght];
    }
    ...
    @SuppressWarnings("unchecked")
    public static @NotNull <T> T[] concatElements(Class<T> kind, @Nullable T[] a, @Nullable T[] b) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static @NotNull <T> T[] appendElement(Class<T> kind, @Nullable T[] array, T element) {
    ...
    public static @NotNull <T> ArraySet<T> add(@Nullable ArraySet<T> cur, T val) {
        if (cur == null) {
            cur = new ArraySet<>();
        }
        cur.add(val);
    ...
    public static @NotNull <T> ArrayList<T> add(@Nullable ArrayList<T> cur, T val) {
        if (cur == null) {
            cur = new ArrayList<>();
        }
        cur.add(val);
