...
public class ParseQuery<T extends ParseObject> {
     ...
     */
    public static <T extends ParseObject> ParseQuery<T> getQuery(@NotNull Class<T> subclass) {
     ...
     * @return A new {@code ParseQuery}.
     */
    public static <T extends ParseObject> ParseQuery<T> getQuery(@NotNull String className) {
     ...
     * @return this, so you can chain this call.
     */
    public ParseQuery<T> whereEqualTo(@NotNull String key, Object value) {
    ...
    public static class State<T extends ParseObject> {
        ...
        public static class Builder<T extends ParseObject> {
            ...
            public static <T extends ParseObject> Builder<T> or(List<Builder<T>> builders) {
                ...
                return new Builder<T>(className)
