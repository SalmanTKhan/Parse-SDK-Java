  ...
  */
    ...
    Task<Void> saveAsync(final String sessionToken, final Task<Void> toAwait) {
        ...
        return task.onSuccessTask(
            ...
            @Override
            public Task<Void> then(final Task<State> saveTask) {
     ...
     */
    public void increment(@NotNull String key, @NotNull Number amount) {
     ...
     */
    public void addAll(@NotNull String key, Collection<?> values) {
     ...
     * @param value The object to add.
     */
    public void addUnique(@NotNull String key, Object value) {
     ...
     * @param values The objects to add.
     */
    public void addAllUnique(@NotNull String key, Collection<?> values) {
     ...
     */
    public void removeAll(@NotNull String key, Collection<?> values) {
        checkKeyIsMutable(key);
     ...
     */
    @Nullable
    public ParseObject getParseObject(@NotNull String key) {
     ...
     */
    @Nullable
    public ParseUser getParseUser(@NotNull String key) {
        Object value = get(key);
     ...
     */
    @Nullable
    public ParseFile getParseFile(@NotNull String key) {
        Object value = get(key);
        if (!(value instanceof ParseFile)) {
            return null;
        }
     ...
     */
    @Nullable
    public ParseGeoPoint getParseGeoPoint(@NotNull String key) {
        synchronized (mutex) {
            checkGetAccess(key);
            Object value = estimatedData.get(key);
     ...
     */
    @Nullable
    public ParsePolygon getParsePolygon(@NotNull String key) {
        synchronized (mutex) {
            checkGetAccess(key);
            Object value = estimatedData.get(key);
     ...
     * otherwise.
     */
    public boolean isDataAvailable(@NotNull String key) {
        synchronized (mutex) {
     ...
     */
    @NotNull
    public <T extends ParseObject> ParseRelation<T> getRelation(@NotNull String key) {
        synchronized (mutex) {
